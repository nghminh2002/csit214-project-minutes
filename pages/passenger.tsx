...
function Passenger() {
  ...
  return (
    <BackGround>
      ...
      <Container>
        ...
        <InputGrid container>
          <Grid item xs={6}>
            <Box sx={{ maxWidth: '97%' }}>
              <FormControl fullWidth>
                <InputLabel id="demo-simple-select-label" error={genderError}>Gender</InputLabel>
                <Select
          ...
          <Grid item xs={6}>
            <Box sx={{ maxWidth: '97%' }}>
              <FormControl fullWidth>
                <InputLabel id="demo-simple-select-label" error={nationError}>Nationality</InputLabel>
                <Select
                  labelId="demo-simple-select-label"
                  id="demo-simple-select"
                  name="nation"
      ...
      <Container style={{ backgroundColor: "rgb(244,245,246)", height: '200px' }}>
        <NextButton variant="contained" onClick={handleSubmit}>Next Step</NextButton>
      </Container>
    </BackGround>
  );
}
